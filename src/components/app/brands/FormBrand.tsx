...
import { toast } from 'react-toastify'; import htmlToDraft from 'html-to-draftjs';
...
const FormBrand = ({ open, onClose, brand, type = 'Add' }: FormBrandProps) => {
    ...
    const onSubmit = async (data: FormCreateBrand) => {
        ...
        if (type === 'Add') {
            ...
            onUpdateBrand(brand?._id || "", newData, () => {
                onClose()
                reset(defaultValues)
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            />
                            {errors.logo && <Typography.Text type="danger">{errors.logo?.message}</Typography.Text>}
                        </div>
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            />
                            {errors.image && <Typography.Text type="danger">{errors.image?.message}</Typography.Text>}
                        </div>
                    </div>
                </div>
            </form>
