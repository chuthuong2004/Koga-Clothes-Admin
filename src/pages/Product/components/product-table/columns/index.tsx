    ...
    },
    {
        ...
        cell: (row, index, column, id) => {
            return <div className="flex gap-2">
                <Image width={100} className="object-contain" src={'https://file.hstatic.net/1000284478/file/birkenstock_ff8c7d7b36e14c668d761dc268c82763.webp'} />
    ...
    },
    {
        ...
        cell: (row, index, column, id) => {
            return <div>
                ...
                <Button type="primary" size='large'>Xoá</Button>
                <Button>Sửa</Button>
                <Button>Xem</Button>
            </div>
        }
