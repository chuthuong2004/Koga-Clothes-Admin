            ...
            <Space direction='vertical' className='w-full'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <Input size="large" placeholder="Nhập giá sản phẩm" status={errors.price && 'error'} {...field} />

                        )}
                    />
                    {
                        errors.price &&
                        <Typography.Text type='danger' >{errors.price?.message}</Typography.Text>
                    }
                </div>
                <div className='flex flex-col gap-2'>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <Input size="large" placeholder="Nhập mã giảm giá" inputMode='numeric' status={errors.discount && 'error'} {...field} />
