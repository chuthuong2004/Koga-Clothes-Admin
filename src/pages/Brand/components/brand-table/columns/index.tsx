...
export const columns: TableColumn<StoreBrand>[] = [
  {
    id: 'image',
    name: 'Image',
      ...
      return (
        <div className="flex gap-4 items-center">
          ...
          <div className="flex-1 items-center">
            ...
            <p className="line-clamp-3" dangerouslySetInnerHTML={{ __html: row.history }} />
          </div>
        </div>
      );
    },
  ...
  },
  {
    ...
    cell: (row, index, column, id) => {
      return <ActionColumn id={row._id} brand={row} />
    },
  },
];
